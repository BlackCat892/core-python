...
class Flight:
    ...
    def relocate_passanger(self,from_seat,to_seat):
      ...
      Args:
        from_seat: The existing seat designator for the passanger to be moved from.
        to_seat: The new seat designator.
      """
      from_row, from_letter = self._parse_seat(from_seat)
      if self._seating[from_row][from_letter] is None:
        raise ValueError(f"No passanger to arelocate in seat {from_seat}")
    ...
    def make_boarding_cards(self, card_printer):
      for passanger, seat in sorted(self._passenger_seats()):
